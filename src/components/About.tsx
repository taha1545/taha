        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          <div className="space-y-6 animate-slide-up">
            ...
            <p className="text-muted-foreground leading-relaxed">
              I'm Taha, a full-stack developer and network engineer student based in Algeria, with over 4 years
            ...
            <p className="text-muted-foreground leading-relaxed">
              ...
              Proficient in Express, php with Laravel, JavaScript, and React, I seamlessly integrate backend logic
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground">Front Projects</div>
              </div>
              <div className="text-center">
